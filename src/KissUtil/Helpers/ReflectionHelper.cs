...
namespace KissUtil.Helpers
{
    ...
    public static partial class ReflectionHelper
    {
        ...
        {
            return ObjectConvert.To<T>(Activator.CreateInstance(type, parameters));
        }
        ...
        public static List<EnumItem> GetPublicProperties(object instance)
        {
            var properties = instance.GetType().GetProperties();
            return properties.ToList().Select(t => new EnumItem(t.Name, t.GetValue(instance))).ToList();
        }
